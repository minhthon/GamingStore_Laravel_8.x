                    ...
                    <div class="left-menu mb-30">
                        <ul>
                         ...
                         $mV=0;
                            for( $i=0;$i<$mLap;$i++)
                            {
                                  if($pc[$i]->classify=="pc Gaming"){
                                      $mG++;
                                  } 
                                  if($pc[$i]->classify=="pc Doanh Nhân"){
                                    $mD++;
                                }  
                                if($pc[$i]->classify=="pc Văn Phòng"){
                                    $mV++;
                                } 
                            }
                         ...
                         ?>
                            ...
                            <li><a href="pcgaming">PC Gaming<span>(<?php echo $mG; ?>)</span></a></li>
                            <li><a href="pctamtrung"> PC Văn Phòng<span>(<?php echo $mD; ?>)</span></a></li>
                            <li><a href="pccaocap">PC Workstation<span>(<?php echo $mV; ?>)</span></a></li>                           
                        </ul>
                    </div>            
