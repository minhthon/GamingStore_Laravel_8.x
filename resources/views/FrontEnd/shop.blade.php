                ...
                <div class="shop-left">
                    ...
                    <div class="left-menu mb-30">
                        <ul>
                            ...
                            <?php $mLap=count($laptop);?>                         
                            <?php $mPC=count($pc);?>
                            <?php $mMor=count($monitor);?>
                            <li><a href="laptop">Laptop<span>(<?php echo $mLap ?>)</span></a></li>
                            <li><a href="monitor">Màn hình<span>(<?php echo $mMor ?>)</span></a></li>
                            <li><a href="pc">PC<span>(<?php echo $mPC ?>)</span></a></li>                           
                        </ul>
                    </div>            
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="th">
                        <div class="row"> 
                            ...
                            <?php for($i=0;($i<4 && $i<$mLap);$i++){ ?>   
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <!-- single-product-start -->
                                    <div class="product-wrapper mb-40">
                                        <div class="product-img">
                                            <a href="#">
                                            <img style="height:200px;" src="{{asset('product/'. $laptop[$i]->image)}}" width="500" height="300" />
                                            </a>
                            ...
                            <?php for($i=0;($i<$mPC && $i<4);$i++){ ?>   
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <!-- single-product-start -->
                                    <div class="product-wrapper mb-40">
                                        <div class="product-img">
                                            <a href="#">
                                            <img style="height:200px;" src="{{asset('product/'. $pc[$i]->image)}}" width="500" height="300" />
                                            </a>
