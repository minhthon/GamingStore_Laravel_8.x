            ...
            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                            <div class="flexslider">
                                <ul class="slides">
                                    ...
                                    <img src="{{asset('product/'. $pc->image)}}" width="500" height="300" />
                                    </li>
                            ...
                            <div class="product-info-main">
                                ...
                                <div class="product-info-price">
                                    <div class="price-final">
                                        <span> {{ number_format($pc->price) }} VND</span>
                        ...
                        <div class="tab-pane active" id="Details">
                            ...
                            <p>{{$pc->name}}</p>
                                <ul>
                                    ...
                                    <li><i class="fa fa-circle"></i>Ổ đĩa : {{$des->hdd}}.</li>
                                    <li><i class="fa fa-circle"></i>SSD : {{$des->ssd}}.</li>
                                    <li><i class="fa fa-circle"></i>Case : {{$des->case}}.</li>
                                    <li><i class="fa fa-circle"></i>Tản nhiệt : {{$des->cooling}}.</li>
                ...
                <div class="new-book-area mt-60">
                    ...
                    <div class="tab-active-2 owl-carousel">
                        ...
                        <?php for($i=0;( $i<count($pc1)&& $i<8);$i++){ ?>   
                        <div class="product-wrapper">
                            <div class="product-img">
                                <a href="#">
                                <img src="{{asset('product/'. $pc1[$i]->image)}}"  />
                                </a>
                            ...
                            <div class="product-details text-center">
                                ...
                                <h4><a href="<?php echo $pc1[$i]->id;?>">{{ $pc1[$i]->name }}</a></h4>
                                <div class="product-price">
                                    <ul>
                                    <li> <p><strong>Price: </strong> {{ number_format($pc1[$i]->price) }} VND </p></li>
                                    </ul>
                                </div>
                            </div>
