...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       Bạn có chắc là mình muốn xóa pc này không?
      </div>
 ...
 <!-- Kết thúc model bootstrap delete pc -->
<!-- Model bootstrap khóa pc -->
<div class="modal fade" id="lock" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
     Bạn có muốn mở khóa PC mày?
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Thoát</button>
        <button id="lockpc" type="button" class="btn btn-primary">Xác nhận</button>
      </div>
    </div>
  </div>
</div>
 <!-- Kết thúc model bootstrap  khóa pc-->
<table class="table table-hover">
  ...
  @foreach($product ?? '' as $product)
      <tr>
        ...
        <td><a  class="btn btn-danger"><i class="fa fa-lock unlock" id="<?php echo $product->id ?>" data-toggle="modal" data-target="#lock"></i></a></td>
 ...
 <script>
  ...
  $('.unlock').click(function (e) {
   ...
   $('#lockpc').click(function(e){  
     $.ajax({       
        url: "unlockPC/"+id_lock,
        cache:false,
        success :function(data){
          if(data.trim()=="SUCCESS"){           
            // $(this).closest('tr.delete_row').remove();    
            alert ("Mở khóa pc thành công");  
            location.reload()  ;  
          };
        }
     })
